...
function WorkEditor({
  ...
  useEffect(() => {
    dispatch({ type: 'UPDATE_BLOCK', section: 'work', id: blockId, payload: values })
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <FieldRow label="Start Date" htmlFor={`${blockId}-start`} error={errors.startDate?.message}>
          <Input id={`${blockId}-start`} placeholder="YYYY-MM" {...register('startDate')} />
        </FieldRow>
        <FieldRow label="End Date" htmlFor={`${blockId}-end`} error={errors.endDate?.message}>
          <Input id={`${blockId}-end`} placeholder="YYYY-MM or leave blank" {...register('endDate')} />
        </FieldRow>
      </div>
...
function EducationEditor({
  ...
  useEffect(() => {
    dispatch({ type: 'UPDATE_BLOCK', section: 'education', id: blockId, payload: values })
  }, [JSON.stringify(values)]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <FieldRow label="Degree" htmlFor={`${blockId}-type`} error={errors.studyType?.message}>
        <Input id={`${blockId}-type`} placeholder="e.g. Bachelor" {...register('studyType')} />
      </FieldRow>
...
function SkillEditor({
  ...
  useEffect(() => {
    dispatch({ type: 'UPDATE_BLOCK', section: 'skills', id: blockId, payload: values })
  }, [JSON.stringify(values)]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <FieldRow label="Level" htmlFor={`${blockId}-level`} error={errors.level?.message}>
        <Input id={`${blockId}-level`} placeholder="e.g. Expert, Intermediate" {...register('level')} />
      </FieldRow>
      <FieldRow label="Keywords" htmlFor={`${blockId}-keywords`} error={errors.keywords?.message}>
        <Input id={`${blockId}-keywords`} placeholder="Comma-separated, e.g. HTML, CSS, JS" {...register('keywords')} />
      </FieldRow>
    </div>
  )
}
...
function ProjectEditor({
  ...
  useEffect(() => {
    dispatch({ type: 'UPDATE_BLOCK', section: 'projects', id: blockId, payload: values })
  }, [JSON.stringify(values)]) // eslint-disable-line react-hooks/exhaustive-deps
...
function VolunteerEditor({
  ...
  useEffect(() => {
    dispatch({ type: 'UPDATE_BLOCK', section: 'volunteer', id: blockId, payload: values })
  }, [JSON.stringify(values)]) // eslint-disable-line react-hooks/exhaustive-deps
...
function AwardEditor({
  ...
  useEffect(() => {
    dispatch({ type: 'UPDATE_BLOCK', section: 'awards', id: blockId, payload: values })
  }, [JSON.stringify(values)]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <FieldRow label="Date" htmlFor={`${blockId}-date`} error={errors.date?.message}>
        <Input id={`${blockId}-date`} placeholder="YYYY-MM" {...register('date')} />
      </FieldRow>
...
function PublicationEditor({
  ...
  useEffect(() => {
    dispatch({ type: 'UPDATE_BLOCK', section: 'publications', id: blockId, payload: values })
  }, [JSON.stringify(values)]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <FieldRow label="Release Date" htmlFor={`${blockId}-date`} error={errors.releaseDate?.message}>
        <Input id={`${blockId}-date`} placeholder="YYYY-MM" {...register('releaseDate')} />
      </FieldRow>
      <FieldRow label="URL" htmlFor={`${blockId}-url`} error={errors.url?.message}>
        <Input id={`${blockId}-url`} type="url" {...register('url')} />
      </FieldRow>
...
function LanguageEditor({
  ...
  useEffect(() => {
    dispatch({ type: 'UPDATE_BLOCK', section: 'languages', id: blockId, payload: values })
  }, [JSON.stringify(values)]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <FieldRow label="Fluency" htmlFor={`${blockId}-fluency`} error={errors.fluency?.message}>
        <Input id={`${blockId}-fluency`} placeholder="e.g. Native speaker, Fluent" {...register('fluency')} />
      </FieldRow>
    </div>
  )
}
...
function InterestEditor({
  ...
  useEffect(() => {
    dispatch({ type: 'UPDATE_BLOCK', section: 'interests', id: blockId, payload: values })
  }, [JSON.stringify(values)]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <FieldRow label="Keywords" htmlFor={`${blockId}-kw`} error={errors.keywords?.message}>
        <Input id={`${blockId}-kw`} placeholder="Comma-separated" {...register('keywords')} />
      </FieldRow>
    </div>
  )
}
...
function ReferenceEditor({
  ...
  useEffect(() => {
    dispatch({ type: 'UPDATE_BLOCK', section: 'references', id: blockId, payload: values })
  }, [JSON.stringify(values)]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <FieldRow label="Reference" htmlFor={`${blockId}-ref`} error={errors.reference?.message}>
        <Textarea id={`${blockId}-ref`} rows={4} {...register('reference')} />
      </FieldRow>
    </div>
  )
}
...
function CertificateEditor({
  ...
  useEffect(() => {
    dispatch({ type: 'UPDATE_BLOCK', section: 'certificates', id: blockId, payload: values })
  }, [JSON.stringify(values)]) // eslint-disable-line react-hooks/exhaustive-deps
...
export function BlockEditor({ section, blockId, initialValues }: BlockEditorProps) {
